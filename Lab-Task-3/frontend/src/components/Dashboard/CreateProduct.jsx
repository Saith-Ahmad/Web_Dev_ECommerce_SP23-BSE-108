...
function CreateProduct({refresh}) {
  ...
  const handleImageUpload = async () => {
    ...
    formData.append("upload_preset", "Web_Technology"); // Replace with your Cloudinary upload preset
    formData.append("cloud_name", "ahmadwebdev"); // Replace with your Cloudinary cloud name
